...
export default function LearnMain() {
  return (
    <div>
      ...
      <p>
        ※Your Learn Progress, LC and all others will be deleted if you{' '}
        {`"try
        learn".`}{' '}
        It will not erase if you created an account or logged in even after{' '}
        {`"try learn"`} before off or quit.
      </p>
