...
export default class SignUp extends Component {
    ...
    render() {
        ...
        return (
            <div className="SignUp">
                ...
                <input className="form-control" style={{width: '20%', marginLeft: '40%', textAlign: 'center'}} placeholder="First Name"/> 
                <input
    ...
    onButtonClick() {
        ...
        if (password === pwConfirm) {
            request.get(`${URL}/user?username=${username}&password=${password}`).then(
